...
export const workbench = {
  ...
  specs: {
    ...
    printing: ["不印刷", "1 色", "2 色", "3 色", "4 色", "4 色以上（含专色）", "不确定"],
    finishes: ["烫金", "击凸 / 凹凸", "触感膜", "局部 UV", "压纹", "贴标 / 不干胶", "暂时不做"],
    lamination: ["亮膜", "哑膜", "不确定"],
  },
  qty: {
    title: "数量与报价",
    moqNote: "起订量 5,000 个 —— 数量不能低于 5,000。",
    pickHint: "选一个或多个数量档；每选一档，下面就会多一条报价记录。",
    tiers: [
      { v: 5000, label: "5,000" },
    ...
    below: { v: 2000, label: "2,000", note: "低于起订量，需要单独确认" },
    askBelow: "要 2,000 怎么办？问 Packy",
    recordTitle: "我的报价记录",
    recordEmpty: "还没选数量档。上面选一档，这里就会生成一条报价记录。",
    recordStatus: "待 PACKGO 报价",
    recordNote: "报价由 PACKGO 出具；这里是你登记下来的询价记录，出价后会写回同一行。",
  },
  projects: {
    title: "我的项目",
